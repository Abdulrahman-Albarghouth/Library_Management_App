...
public class UpdateAuthorFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v =  inflater.inflate(R.layout.fragment_update_author,container,false);
        ...
        btnupdate = v.findViewById(R.id.btn_updateauthor);
        ...
        btnupdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    boolean result = ads.updateAuthorData(au,id);
                    if (result) {
                        onCreateDialog();
                    } else {
